  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 w-full">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <button type="button" onClick={simulateCritical} className="btn-glass px-4 py-2 text-xs sm:text-sm">Simulate Critical Case</button>
      </div>
      ...
      <button type="submit" className="btn-glass w-full px-5 py-3 text-sm font-medium">Submit Vitals</button>
    </form>
  )
}
